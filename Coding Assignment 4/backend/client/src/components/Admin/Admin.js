...
class Admin extends Component {
  ...
  openEdit = id => {
    let user = adminStore.getUser(id)
    if (user) {
      this.setState({
        editModalOpen: true,
        workingUser: id,
  ...
  deleteUser = () => {
    adminStore.deleteUser(this.state.workingUser).then(done => {
      if (done) {
        this.setState({
          name: '',
          email: '',
  ...
  render() {
    return (
      <div className='mainContainer'>
        ...
        <div className='contentContainer'>
          ...
          <div className='right'>
            ...
            <div className='floatRight'>
              <button onClick={this.openNew}>New User</button>
            </div>
            <ul className='leftList'>
              {adminStore.users.map((item, i) => (
                <li key={item._id}>
                  {item.name} ({item.role})
        ...
        >
          <Header icon='browser' content='Add a new user' />
          <Modal.Content>
            <div className='form'>
